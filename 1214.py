...
def mostrar_menu():
    ...
    opciones = {
        ...
        '7': 'Zejemplosvarios20/clae libro.py/Control de Conexiones de Base de Datos.py/Código Python.py/EJEMPLO  CLASE 7.py/Gestión de Archivos.py/Gestión de Procesos Temporales.py/Gestión de una Cola de Tareas.py/Gestión de vehículos concesionario.py/Personaje basico.py/Policia victima y delincuente.py/Programación Orientada a Objetos (POO) semana3.py/PRUEBAS.py/Tecnicas de Programacion.py',
